    ...
    */
    ...
    ventana.poner_de_primero = () => {
        ...
        function AgregarElementoAlDOM() {
            if (!VENTANA_FLOTANTE_V1.AGRUPAMIENTO.contains(ventana)) {
                VENTANA_FLOTANTE_V1.AGRUPAMIENTO.prepend(ventana);
            }
        }

        function primerZindex() {
            VENTANA_FLOTANTE_V1.AGRUPAMIENTO.eliminarFirstChild();

            ventana.classList.add("is-firt-child");

            let hermanos = [...VENTANA_FLOTANTE_V1.AGRUPAMIENTO.querySelectorAll(".ventana-flotante-tipo-windows")].filter(hermano => hermano != ventana);
            hermanos.sort((a, b) => {
    ...
    ventana.ocultar_elementos_por_maximizacion = () => {
        VENTANA_FLOTANTE_V1.AGRUPAMIENTO.querySelectorAll(".ventana-flotante-tipo-windows").forEach(elemento => {
    ...
    ventana.mostrar_elementos_por_desmaximizacion = () => {
        VENTANA_FLOTANTE_V1.AGRUPAMIENTO.querySelectorAll(".ocultar-por-maximizacion").forEach(elemento => {
