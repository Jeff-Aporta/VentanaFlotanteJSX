VENTANA_FLOTANTE_V1.AGRUPAMIENTO.eliminarFirstChild = () => {/**
    ...
    */
    let ventanas = [...VENTANA_FLOTANTE_V1.AGRUPAMIENTO.querySelectorAll(".ventana-flotante-tipo-windows")];
    ventanas.forEach(ventana => ventana.classList.remove("is-firt-child"));
};

VENTANA_FLOTANTE_V1.AGRUPAMIENTO.distribuir_ventanas_en_sistema_de_cuadricula = (columnas, filas) => {/**
...
VENTANA_FLOTANTE_V1.AGRUPAMIENTO.nuevaVentana = (props) => {/**
        * Crea una nueva ventana flotante tipo Windows
    */
    let ventana = VENTANA_FLOTANTE_V1.CREAR(props);
